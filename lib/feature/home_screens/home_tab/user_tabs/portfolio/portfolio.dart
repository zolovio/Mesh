...
class Pictures extends StatefulWidget {
  Pictures({Key? key, this.video = false, this.edit = false}) : super(key: key);
  final bool video;
  final bool edit;
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                                ...
                                decoration:
                                    BoxDecoration(border: Border.all(color: Theme.of(context).focusColor), borderRadius: BorderRadius.circular(8)),
                                child: Text("Connect",
                                    style: TextStyle(color: Theme.of(context).focusColor, fontSize: 14, fontWeight: FontWeight.w600))),
                          )
                        ],
                      ),
                    ))
